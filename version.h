...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3082;
	#define RC_FILEVERSION 1,6,21,43
	#define RC_FILEVERSION_STRING "1, 6, 21, 43\0"
	static const char FULLVERSION_STRING [] = "1.6.21.43";
