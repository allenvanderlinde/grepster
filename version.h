...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3133;
	#define RC_FILEVERSION 1,6,45,10
	#define RC_FILEVERSION_STRING "1, 6, 45, 10\0"
	static const char FULLVERSION_STRING [] = "1.6.45.10";
